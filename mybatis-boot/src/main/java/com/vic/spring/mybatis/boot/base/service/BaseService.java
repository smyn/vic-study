package com.vic.spring.mybatis.boot.base.service;
...
import com.vic.spring.mybatis.boot.base.annotation.Unique;
import com.vic.spring.mybatis.boot.base.dto.BaseForm;
import com.vic.spring.mybatis.boot.base.dto.BaseQuery;
import com.vic.spring.mybatis.boot.base.exception.BusinessException;
import com.vic.spring.mybatis.boot.base.mode.BaseModel;
...
public abstract class BaseService<T extends BaseModel, F extends BaseForm,Q extends BaseQuery<T>> implements IBaseService<T,F,Q>{
    ...
    public int deleteById(Serializable id) {
        ...
        if(id == null){
            throw new BusinessException("id is must not null");
        }
    ...
    private void checkOneUnique(Object[] pkInfo,String uniqueColumn,Object uniqueValue){
        ...
        if(t != null){
            throw new BusinessException(StringUtils.underlineToCamel(uniqueColumn)+":"+uniqueValue+" is already in use");
        }
    }
